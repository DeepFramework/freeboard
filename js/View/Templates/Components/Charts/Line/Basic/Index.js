...
define(defineModule, function(Base) {
    var LineBasicChart = function() {
        Base.object.apply(this);

        var self = this;
        self.componentName = 'Charts-Line-Basic';
        ...
        self.instance = function(data) {
            ...
            self.componentDisplaySettingData.title = self.isExistAndNoEmptyAttribute(data.componentDisplaySettingData.title) ?
                data.componentDisplaySettingData.title : self.componentDisplaySettingData.title;
            self.componentDisplaySettingData.subtitle = self.isExistAndNoEmptyAttribute(data.componentDisplaySettingData.subtitle) ?
        ...
        self.exe = function(data) {
            ...
            $(document).ready(function() {
                $('#M_' + self.componentDisplaySettingData.renderId).append(
                    '<div id="M_charts_Line_Basic"></div>'
                );
                $('#M_' + self.componentDisplaySettingData.renderId + ' #M_charts_Line_Basic').highcharts({
                    title: {
                ...
                self.obj = $('#M_' + self.componentDisplaySettingData.renderId + ' #M_charts_Line_Basic').highcharts();
            });
        }
    }

    return {
        object: LineBasicChart
    }
});
